...
public class ProductApi {
    ...
    public ResponseEntity<MessageResponse> createBaseProduct(@RequestBody ProductBase request) throws BaseException {
        MessageResponse res = productBaseController.createProductBase(request.getProdTitle());
    ...
    public ResponseEntity<MessageResponse> updateBase(@RequestBody ProductBase request) throws BaseException {
        MessageResponse res = productBaseController.updateProductBase(request.getProdBaseId(), request.getProdTitle(), request.getDescription(), request.getIsEnable());
        return ResponseEntity.ok(res);
    }

    @PutMapping("/updateIntoCategory")
    public ResponseEntity<MessageResponse> updateProductBaseInToCategory(@RequestBody ForCategoryResponse request) throws BaseException {
        MessageResponse res = productBaseController.updateProductBaseIntoCategory(request.getCateId(), request.getProductBase());
        return ResponseEntity.ok(res);
    }
    ////////////////////////
    ...
    public ResponseEntity<MessageResponse> findBaseById(@RequestParam(name = "baseId" , required = false) String baseId,
                                                        ...
                                                        @RequestParam(name = "form", required = false) String form) throws BaseException {
        MessageResponse res = productBaseController.findProductBase(baseId, cateId, minPrice, form);
        return ResponseEntity.ok(res);
    }
    ////////////////////
    ...
    public ResponseEntity<MessageResponse> createForm(@RequestBody ForProductFormResponse request) throws BaseException {
        MessageResponse res = productFormController.createProductForm(request.getProductBaseId(), request.getProdForm(), request.getPrice(), request.getDescription());
        return ResponseEntity.ok(res);
    }
    ...
    public ResponseEntity<MessageResponse> updateForm(@RequestBody ProductForm request) throws Exception {
        MessageResponse res = productFormController.updateProductForm(request.getProdFormId(), request.getProdForm(), request.getPrice(), request.getDescription(), request.getIsEnable());
        return ResponseEntity.ok(res);
    }
    ...
    public ResponseEntity<MessageResponse> findListFormByBaseId(@RequestParam(name = "formId" , required = false) String formId,
        ...
        MessageResponse res = productFormController.findProductForm(formId, baseId, addOn, option);
        return ResponseEntity.ok(res);
    }
